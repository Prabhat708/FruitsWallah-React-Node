  ...
  return (
    <>
      ...
      <p>
        ...
        version will take precedence over the translation FruitsWallah Terms of Use
        ...
        FruitsWallah Internet Private Limited, a company incorporated under the
        Companies Act, 1956 with its registered office at Buildings Alyssa,
        Begonia & Clover, Embassy Tech Village, Outer Ring Road,
        ...
        "FruitsWallah"). Your use of the Platform and services and tools are
        ...
        shall be contracting with FruitsWallah Internet Private Limited and these
        terms and conditions including the policies constitute Your binding
        obligations, with FruitsWallah. For the purpose of these Terms of Use,
        ...
        Registered User using the computer systems. FruitsWallah allows the User to
        surf the Platform or making purchases without registering on the
        Platform. The term "We", "Us", "Our" shall mean FruitsWallah Internet
        ...
        also accept and agree to be bound by FruitsWallah Policies ((including but
        ...
        by your legal guardian or parents. FruitsWallah reserves the right to
        terminate your membership and / or refuse to provide you with access to
        the Platform if it is brought to FruitsWallah's notice or if it is
        ...
        FruitsWallah shall not be liable or responsible for the activities or
        ...
        at the end of each session; and (b) immediately notify FruitsWallah of any
        ...
        without any liability to FruitsWallah, for such period of time as we deem
        ...
        have access to other apps owned by FruitsWallah group companies through the
        same login username and password. You agree to have single login access
        to all the apps owned by FruitsWallah group companies. Communications When
        ...
        on the Platform. FruitsWallah is not and cannot be a party to or control in
        any manner any transaction between the Platform's Users.
      </p>
    </>
  );
}
