...
import { FaCreditCard, FaInfoCircle, FaMobileAlt, FaMoneyBillAlt } from 'react-icons/fa'
    ...
    <div className="row mb-4">
        ...
        <div className="row">
          <div className="col-lg-6">
            <div className="alert alert-info fw-medium">
                ...
                <div className="card-header">
                    <div className="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                        <ul role="tablist" className="nav bg-light nav-pills rounded nav-fill mb-3">
                            <li className="nav-item"> <a data-toggle="pill" href="#credit-card" className="nav-link active "> <FaMoneyBillAlt/> UPI </a> </li>
                            <li className="nav-item"> <a data-toggle="pill" href="#paypal" className="nav-link "> <FaCreditCard/> Credit Card/Debit Card</a> </li>
                            <li className="nav-item"> <a data-toggle="pill" href="#net-banking" className="nav-link "><FaMobileAlt/> Net Banking </a> </li>
                        </ul>
                    </div> 
