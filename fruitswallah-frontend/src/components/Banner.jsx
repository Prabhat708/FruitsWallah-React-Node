        ...
        <div className="row g-4 align-items-center">
            ...
            <div className="col-lg-6">
                <div className="position-relative">
                    ...
                    <div className="d-flex align-items-center justify-content-center bg-white rounded-circle position-absolute top-0 end-0" style={{width: "95px", height: "95px", transform: "translate(50%, -50%)"}}
                        >
                        <h1 >1</h1>
